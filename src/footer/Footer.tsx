    ...
    return (
        <div className={styles.footer}>
            <div className={styles.container}>
                ...
                <div className={styles.tel}>Tel <span className={styles.tel_inner}>+7 917 825 83 46</span></div>
                <div className={styles.mail}>e-mail: <span className={styles.mail_inner}>solnseviktor@gmail.com</span>
                </div>
